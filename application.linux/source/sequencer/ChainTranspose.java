...
public class ChainTranspose extends ChainDevice {
	...
	private float transposeRatio = 0;

	public ChainTranspose ()
	{
	...
	public float getTransposeRatio()
	{
		return this.transposeRatio;
	}
	public void setTransposeRatio(float tr)
	{
		this.transposeRatio = tr;
	}
	...
	{
		double pitch = (double)(n.getPitch() + transposeRatio);
